function [leftEyeAll, rightEyeAll, timeStampAll, selectedItem] = TwoPassiveFixationPointsBB(buttonBox, fixation1, fixation2, gabor, win, resolution, sampleNum)

%TwoPassiveFixationPointsBB(Stim1,Stim2,Stim3, win, resolution, 1000);
